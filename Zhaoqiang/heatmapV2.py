...
class HeatMap:
    def __init__(self, mriBrainMask, posTable, scoreTable):
        ...
        self.PosX, self.PosY, self.PosZ = readPos(posTable)
        self.POS_FLAG = YES_READIN
        print('Load Electrodes positions successfully')

        # score is m channel x n time numpy array
        self.Score, self.ChannelNum, self.timestep = readScore(scoreTable)
...
if __name__ == '__main__':
    ...
    posTable = ''
    scoreTable = ''
    Test = HeatMap(brain,posTable,scoreTable)
